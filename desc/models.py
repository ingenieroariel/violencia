...
class Educacion(models.Model):
    ...
    nivel_educativo_mediatec = models.DecimalField(help_text="en % (Porcentaje)", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Media vocacional tecnica")
...
class InstitucionEducativa(models.Model):
    ...
    tiene_pei = models.BooleanField()
    tiene_pec = models.BooleanField()
...
class SistemaSalud(models.Model):
    ...
    reg_sub_carnetizado_indigena_porcentaje = models.DecimalField(help_text="% de indigenas del municipio", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Poblacion indigena")
    ...
    reg_sub_carnetizado_afro_porcentaje = models.DecimalField(help_text="% de afros del municipio", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Poblacion afro")
    ...
    reg_sub_carnetizado_otra_porcentaje = models.DecimalField(help_text="% de otros del municipio", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Otra poblacion")
    ...
    reg_sub_vinculado_indigena_porcentaje = models.DecimalField(help_text="% de indigenas del municipio", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Poblacion indigena")
    ...
    reg_sub_vinculado_afro_porcentaje = models.DecimalField(help_text="% de afros del municipio", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Poblacion afro")
    ...
    reg_sub_vinculado_otra_porcentaje = models.DecimalField(help_text="% de otros del municipio", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Otra poblacion")
    ...
    reg_contributivo_indigena_porcentaje = models.DecimalField(help_text="% de indigenas del municipio", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Poblacion indigena")
    ...
    reg_contributivo_afro_porcentaje = models.DecimalField(help_text="% de afros del municipio", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Poblacion afro")
    ...
    reg_contributivo_otra_porcentaje = models.DecimalField(help_text="% de otros del municipio", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Otra poblacion")
...
class DerechoAlTrabajo(models.Model):
    ...
    trabajo_informal = models.DecimalField(help_text="en % (Porcentaje)", max_digits=5, decimal_places=2, null=True, blank=True)
    trabajo_formal = models.DecimalField(help_text="en % (Porcentaje)", max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Trabajo formal (Empleo)")
