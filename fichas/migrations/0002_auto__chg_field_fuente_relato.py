...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fuente.relato'
        db.alter_column('fichas_fuente', 'relato_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['fichas.Relato']))


    def backwards(self, orm):
        
        # Changing field 'Fuente.relato'
        db.alter_column('fichas_fuente', 'relato_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fichas.Relato']))
