...
class Estadistica(models.Model):
    ...
    hombres = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    mujeres = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_0_a_4 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_5_a_9 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_10_a_14 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_15_a_19 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_20_a_24 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_25_a_29 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_30_a_34 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_35_a_39 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_40_a_44 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_45_a_49 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_50_a_54 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_55_a_59 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_60_a_64 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_65_a_69 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_70_a_74 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_75_a_79 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_80_a_84 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_85_a_89 = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    edad_90_o_mas = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    etnia_indigena = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    etnia_afro = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    etnia_otros = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
    etnia_no_informa = models.DecimalField(help_text="%", max_digits=4, decimal_places=2, blank=True, null=True)
...
class TerritorioComunidad(Territorio):
    ...
    def municipios_del_territorio(self):
        nombres = []
        for m in self.municipios.all().order_by('departamento'):
