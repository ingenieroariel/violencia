...
class PoblacionGrande(models.Model):
    total = SmallIntegerField(verbose_name="Poblaci�n Total", default=0)
...
class PlanOrdenamiento(models.Model):
    ...
    expansion_urbana_limite = TextField(verbose_name='Expansi�n Urbana Limite (Proyecci�n)') #gis?
...
class Municipio(TerritorioPolitico):
    ...
    area = IntegerField(verbose_name='�rea (km2) total')
    """Cabecera municipal"""
