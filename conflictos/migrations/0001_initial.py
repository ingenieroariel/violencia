...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conflictos_conflicto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='content_type_conflicto', null=True, to=orm['contenttypes.ContentType'])),
            ...
            ('fuente', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='conflictos', null=True, to=orm['fuentes.FuenteDato'])),
        ))
        db.send_create_signal('conflictos', ['Conflicto'])


    def backwards(self, orm):
        
        # Deleting model 'Conflicto'
        db.delete_table('conflictos_conflicto')
    ...
    models = {
        ...
        'conflictos.conflicto': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'content_type_conflicto'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'descripcion': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'estado': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'fuente': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'conflictos'", 'null': 'True', 'to': "orm['fuentes.FuenteDato']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
